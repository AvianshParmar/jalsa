...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-white to-green-50 text-green-500">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-playfair font-semibold text-lg text-green-900">Quick Links</h3>
            <ul className="space-y-2 text-sm">
              {milestones.map((item) => (
                <li key={item.path}>
                  <Link 
                    to={item.path} 
                    className="text-green-800 hover:text-green-600 transition-colors flex items-center space-x-2"
                  >
                    {item.icon}
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="font-playfair font-semibold text-lg text-green-900">Contact Info</h3>
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 mt-1 flex-shrink-0 text-green-800" />
                <a
                ...
                >
                  454c Alexandra Avenue Rayners Lane, Harrow HA2 9TL
                </a>
              </div>
              <div className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 mt-1 flex-shrink-0 text-green-800" />
                <a
                  ...
                  className="text-green-800 hover:text-green-600 transition-colors"
                >
                  734 Kenton Road, Harrow, HA3 9QX
                </a>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-green-800">Mon-Sun: 12pm-10pm</span>
              </div>
            </div>
          </div>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="font-playfair font-semibold text-lg text-green-900">Stay Updated</h3>
            ...
            <div className="space-y-2">
              <Input 
                ...
                className="bg-green-50 border border-green-700 text-green-800 placeholder:text-green-80 text-sm"
              />
              <Button size="sm" className="w-full bg-green-700 hover:bg-green-900 text-white">
                Subscribe
              </Button>
            </div>
            <div className="flex space-x-3 pt-2">
              <a href="https://www.facebook.com/share/16y9xN6AjZ/" className="text-green-700 hover:text-green-600 transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/jalsa.paan/" className="text-green-700 hover:text-green-600 transition-colors">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-green-800 border-opacity-30 mt-12 pt-8">
