...
const Contact = () => {
  ...
  // Order Form handler (can use same template or a different one)
  ...
  },
  {
    ...
    action: { label: "View Hours", link: "#hours" } // anchor to Hours section
  }
];
            ...
            <Card className="product-card">
              ...
              <CardContent>
                 <form onSubmit={handleQuoteSubmit} className="space-y-6">
                   {/* Add name attributes to all fields for EmailJS */}
                  ...
                  <div className="space-y-2 z-10 relative">
                   ...
                   <div className="space-y-2">
                     ...
                     <Textarea name="details" rows={4} className="z-10 relative" placeholder="Additional details" />
                   </div>
                 ...
                 <form onSubmit={handleOrderSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                   ...
                   <div className="space-y-2">
                     ...
                     <Textarea name="instructions" rows={3} className="z-10 relative" placeholder="Special instructions" />
                   </div>
