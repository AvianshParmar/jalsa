...
const Products = () => {
  ...
  const paanProducts = [
    {
      ...
      ingredients: ["Kids Toto Paan", "Sweet Paan Bomb", "Calcutta Sweet Paan", "Calcutta Sada Khara/Khara Meetha Paan"],
      category: "Medley",
      popular: true,
      spiceLevel: 1
    },
    {
      ...
      ingredients: ["Fresh Betel Leaf", "Tobacco", "Lime", "Katha", "Chuna", "Traditional Spices"],
    ...
    },
    {
      ...
      image: sweetPaanImage,
      ingredients: ["Fresh Betel Leaf", "Gulkand (Rose Petals)", "Coconut", "Dates", "Cardamom", "Silver Leaf"],
      category: "Sweet",
      popular: true,
      spiceLevel: 0
    },
    {
      ...
      image: paanVarietiesImage,
      ingredients: ["Kesar Sweet/Sada Paan", "Khas Sweet/Sada Paan", "Ratrani Sweet/Sada Paan", "Strawberry Sweet/Sada Paan"],
      category: "Flavour",
      popular: true,
      spiceLevel: 0
    },
    {
      ...
      image: calcuttaPaanImage,
      ingredients: ["Fresh Betel Leaf", "Premium Quiwam", "Special Spices", "Traditional Preparation"],
      category: "Premium",
      popular: false,
      spiceLevel: 2
    },
    {
      ...
      image: sweetPaanImage,
      ingredients: ["Fresh Betel Leaf", "Sweet Elements", "Spicy Mix", "Balanced Spices"],
      category: "Fusion",
      popular: true,
      spiceLevel: 1
    },
    {
      ...
      image: paanVarietiesImage,
      ingredients: ["Fresh Betel Leaf", "Maghai Mix", "Traditional Spices", "Authentic Preparation"],
      category: "Traditional",
      popular: false,
      spiceLevel: 2
    }
  ...
  const categories = ["All", "Medley", "Traditional", "Sweet", "Flavour", "Premium", "Fusion", "Mukhwas", "Beverages", "Snacks"];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Explore our wide variety of authentic and innovative paan creations, each crafted with the finest ingredients and traditional techniques.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-animation">
            {allProducts.map((product) => (
              <Card key={product.id} className="product-card overflow-hidden h-full">
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    ...
                    <Badge variant="secondary" className={getSpiceLevelColor(product.spiceLevel)}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground">
              Don't see exactly what you're looking for? We're happy to create custom paan combinations based on your preferences and dietary requirements.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <Card className="product-card p-6 text-center">
                <CardContent className="space-y-4">
                  ...
                  <h3 className="font-playfair font-semibold">Custom Ingredients</h3>
                  <p className="text-sm text-muted-foreground">Choose your preferred ingredients and spice levels</p>
                </CardContent>
              </Card>
              <Card className="product-card p-6 text-center">
                <CardContent className="space-y-4">
                  ...
                  <h3 className="font-playfair font-semibold">Special Occasions</h3>
                  <p className="text-sm text-muted-foreground">Beautifully presented paan for events and celebrations</p>
                </CardContent>
              </Card>
              <Card className="product-card p-6 text-center">
                <CardContent className="space-y-4">
                  ...
                  <h3 className="font-playfair font-semibold">Bulk Orders</h3>
                  <p className="text-sm text-muted-foreground">Special pricing for large quantity orders</p>
                </CardContent>
              </Card>
            </div>
